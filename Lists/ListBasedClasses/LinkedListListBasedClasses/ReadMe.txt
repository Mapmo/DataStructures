As the directory name suggests these are implementations of data structures based on LinkedLists, it's important to note that because of the method used to implement the LinkedLists, a LinkedList cannot be entirely empty, because then it will be nullptr and therefore useless(this problem will be resolved when I create a list structure that acts like a container)
